...
def category(request):
    ...
    return render(request, 'my_blog/category.html', {'categories': categories})


def category_articles(request, category_id):
    print(category_id)
    category_name = ArticleColumn.objects.get(id=category_id)
    print(category_name)
    articles = ArticlePost.objects.filter(column=category_name)

    return  render(request, 'my_blog/category_articles.html', {'articles': articles})
